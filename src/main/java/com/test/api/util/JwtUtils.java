...
public class JwtUtils {
	...
	//jwt 토큰 생성
	public String createJwt(Long param1, String param2) {//payload에 넣을 파라미터
        ...
        headers.put("kid", "default");

        //payload 부분 설정
        Map<String, Object> payloads = new HashMap<>();
        Map<String, Object> info = new HashMap<>();
        info.put("userNo", param1);
        info.put("userId", param2);
        
        payloads.put("info", info);
